...
<html><head>
  ...
  <div class="login-box">
    ...
    <div class="login-box-body">
      <p class="login-box-msg" style="color:red;"> <b> Hey !!!!! This Route Does Not Exist  !!!! </b> </p>
      <P style="margin-top:0%;text-align:center;"> <b>404</b></p>
      {{-- <p class="login-box-msg" style="color:blue;"> <b>   ... </b> </p> --}}
      <div class="row">
