...
@section('section')
    ...
    <h1 style="font-size:38px; font-family:'Times New Roman', Times, serif;text-align:center;text-decoration:underline;color:#539AC2"> <i class="fa fa-line-chart"></i> <b>CURRENT YEAR PROGRAM QUATERLY TRENDS.</b>  </h1>
