...
<div class="col-md-8 col-md-offset-2" >
    ...
    <ol>
        ...
        <a href="#groupByquater"> <h4 style="font-family:'Times New Roman', Times, serif;color:darkblue;"> 2.)  A grouped BarChart that shows the current quater perspective trend but grouped by quaters <span style="font-style:italic;color:red;">(click to view.)</span></h4> </a>              
        <a href="#lineGraphs"> <h4 style="font-family:'Times New Roman', Times, serif;color:darkblue;"> 3.) A grouped LineGraph that shows the current quater perspective trend in  quaterly Fashion. <span style="font-style:italic;color:red;">(click to view.)</span></h4> </a>       
    </ol>
    <br>
    <br>
</div>
...
<div class="row" id="groupByProgram">
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="box box-danger">
          ...
          <p style="color:red;font-size:13px;font-style:italic;"> <span> <b>Disclaimer</b> If The Bars are at 1% then the perspective has not been assesed for that quater.</span> </p>
          <div class="box-body">
