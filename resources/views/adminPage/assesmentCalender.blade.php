...
<div class="col-md-10 col-md-offset-1" style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;padding-top:2%;padding-bottom:2%;border-radius:20px;background-color:#D7E0EB;">
        ...
        @endforeach
                ...
                <div class="row" style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">
                    <div class="col-md-4 col-md-offset-1">
                        <h2 style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">Change Year:<span style="font-size:16px;color:rgb(255,0,0);font-family:times new roman;">*not compulsory to fill if in same year*</span></h2>
                    </div>
                ...
                <div class="row" style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">
                    <div class="col-md-4 col-md-offset-1">
                        <h2 style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">Change Quarter :<span style="font-size:16px;color:rgb(255,0,0);font-family:times new roman;">*select from drop down.*</span></h2>
                    </div>
